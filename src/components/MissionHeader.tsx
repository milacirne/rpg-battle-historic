  ...
  return (
    <header className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-5 sm:px-6 sm:py-6 shadow-sm">
      <div className="flex items-start justify-between mb-4">
        ...
        <span className={`px-4 py-1 rounded-full text-s font-medium ${typeColors[type]}`}>{type}</span>
      </div>
      <div className="space-y-2 sm:space-y-1">
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 text-center sm:text-left">{name}</h1>
        <div className="flex flex-wrap justify-center sm:justify-start gap-4 text-gray-600 text-sm mt-3 text-center sm:text-left">
